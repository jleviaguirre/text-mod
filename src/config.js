...
function createConfigButton(context,configDialogContents){
    ...
    configButtonFill      = isDark?"rgba(124, 124, 124, 1.5)":isLight?"rgba(68, 68, 68, 1.5)":invertHex(bgColor);
    configButtonFillHover = isDark?"rgba(143, 143, 143, 1.5)":isLight?"rgba(209, 209, 209, 1.5)":invertHex(bgColor);
